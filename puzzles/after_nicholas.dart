...
// Nicholas Parsons chaired the panel game Just a Minute on BBC Radio for over fifty years.  After he died, the ten people in this puzzle each chaired an episode of Series 86, before Sue Perkins was chosen as the new permanent chair. Each letter used in the puzzle represents a different number from 1 to 16 and the ^ symbol denotes to the power of.  All entries are distinct, and none starts with zero.
  ...
  return PuzzleDefinition.fromString(
    ...
    variables: {
      'A': Variable('A', variableValues),
      'C': Variable('C', variableValues),
      'E': Variable('E', variableValues),
      'G': Variable('G', variableValues),
      'H': Variable('H', variableValues),
      'I': Variable('I', variableValues),
      'J': Variable('J', variableValues),
      'L': Variable('L', variableValues),
      'M': Variable('M', variableValues),
      'N': Variable('N', variableValues),
      'O': Variable('O', variableValues),
      'P': Variable('P', variableValues),
      'S': Variable('S', variableValues),
      'T': Variable('T', variableValues),
      'U': Variable('U', variableValues),
      'Y': Variable('Y', variableValues),
    },
  );
}
