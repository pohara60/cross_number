...
class EvenOdder extends Crossnumber<EvenOdderPuzzle> {
  ...
  void initCrossnumber() {
    ...
    var a16 = EvenOdderEntry(
        name: 'A16', length: 2, valueDesc: 'IO-NS', solve: solveEvenOdderClue);
    puzzle.addEntry(a16);
    ...
    var a38 = EvenOdderEntry(
        name: 'A38', length: 4, valueDesc: 'NI+ELS', solve: solveEvenOdderClue);
    puzzle.addEntry(a38);
    ...
    var d2 = EvenOdderEntry(
        name: 'D2', length: 2, valueDesc: 'T+A-U', solve: solveEvenOdderClue);
    puzzle.addEntry(d2);
    ...
    var d14 = EvenOdderEntry(
        name: 'D14', length: 3, valueDesc: 'UP', solve: solveEvenOdderClue);
    puzzle.addEntry(d14);
